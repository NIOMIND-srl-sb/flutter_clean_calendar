...
class FlutterCleanCalendar extends StatelessWidget {
  ...
  /// - availableDates, It takes the list of disabled dates to be shown as disabled.
  ...
  Widget build(BuildContext context) {
    return Calendar(
      calendarProperties: CalendarProperties(
          ...
          availableDatesProperties: availableDatesProperties,
