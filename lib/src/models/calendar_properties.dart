import 'package:flutter_clean_calendar/src/models/dates_decoration.dart';
import 'package:flutter_clean_calendar/src/models/dates_properties.dart';
import 'package:flutter_clean_calendar/src/models/header_properties.dart';
import 'package:flutter_clean_calendar/src/models/month_year_decoration.dart';
import 'package:flutter_clean_calendar/src/models/months_model.dart';
import 'package:flutter_clean_calendar/src/models/navigator_decoration.dart';
import 'package:flutter_clean_calendar/src/models/weekdays_decoration.dart';
import 'package:flutter_clean_calendar/src/models/weekdays_model.dart';
import 'package:flutter_clean_calendar/src/models/weekdays_properties.dart';
...
class CalendarProperties {
  ...
  /// Disabled dates properties.
  final DatesProperties availableDatesProperties;
  ...
  CalendarProperties({
    ...
    DatesProperties? availableDatesProperties,
    ...
    required this.context,
        ...
        weekdaysProperties = WeekdaysProperties(
            ...
            weekDaysContainerBackgroundColor:
                weekdaysProperties?.weekDaysContainerBackgroundColor ??
                    Colors.white),
        ...
        availableDatesProperties = DatesProperties(
          datesDecoration: DatesDecoration(
            datesBackgroundColor: availableDatesProperties
                    ?.datesDecoration?.datesBackgroundColor ??
                Theme.of(context).colorScheme.primary,
            datesTextColor:
                availableDatesProperties?.datesDecoration?.datesTextColor ??
                    Theme.of(context).colorScheme.onPrimary,
            datesTextStyle:
                availableDatesProperties?.datesDecoration?.datesTextStyle ??
                    const TextStyle(),
            datesBorderColor:
                availableDatesProperties?.datesDecoration?.datesBorderColor ??
                    Theme.of(context).colorScheme.primary,
            datesBorderRadius:
                availableDatesProperties?.datesDecoration?.datesBorderRadius ??
                    12,
          ),
          disable: availableDatesProperties?.disable ?? false,
          hide: availableDatesProperties?.hide ?? false,
        ),
  ...
  bool operator ==(Object other) =>
      ...
      other is CalendarProperties &&
          ...
          availableDatesProperties == other.availableDatesProperties &&
  ...
  int get hashCode =>
      ...
      availableDatesProperties.hashCode ^
